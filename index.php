...
${dadosPrompt.instrucoesIA ? 'INSTRUÇÕES ADICIONAIS:\n' + dadosPrompt.instrucoesIA : ''}`;
    ...
    <!-- HTML2PDF para exportação jurídica perfeita -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js"></script>
<title>Contrato</title><style>body{font-family:'Times New Roman',serif;font-size:12pt;line-height:1.6;margin:2cm;color:#000}pre{white-space:pre-wrap;word-wrap:break-word;font-family:inherit;margin:0}@media print{body{margin:1.5cm}}
        /* ============ PWA & SIGNATURE PAD ============ */
        .pwa-install-btn {
            display: inline-flex;
            align-items: center;
    ...
    <!-- HTML2PDF para exportação jurídica perfeita -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2pdf.js/0.10.1/html2pdf.bundle.min.js"></script>
<meta charset="UTF-8"><title>Contrato</title><style>body{font-family:'Times New Roman',serif;font-size:12pt;line-height:1.8;max-width:800px;margin:40px auto;padding:20px;color:#333}pre{white-space:pre-wrap;word-wrap:break-word;font-family:inherit}
        /* ============ PWA & SIGNATURE PAD ============ */
        .pwa-install-btn {
            display: inline-flex;
            align-items: center;
